    ...
    QWidget(parent)
{
    ...
    toolButton *tbTiJian=new toolButton(":/img/toolWidget/tiJian.png",trUtf8("电脑体检"));
    toolButton *tbMuMa=new toolButton(":/img/toolWidget/muMa.png",trUtf8("木马查杀"));
    toolButton *tbLouDong=new toolButton(":/img/toolWidget/louDong.png",trUtf8("漏洞修复"));
